...
import { useGetRolesQuery } from '../features/apiSlice'
  ...
  return (
    <>
        ...
        <div style={{paddingTop: '10px', paddingLeft: '15px', paddingRight: '15px'}}>
            ...
            {list?.map((usser) => (
                <div onClick={() => navigate(`/role/${usser._id}`)} style={{backgroundColor: '#cccccc', border: '1px solid #666', padding: '7px', display: 'flex', justifyContent: 'space-between'}}>
